    ...
    <div class="body">
        ...
        <div class="publish">
            <form action="../controller/edit.php" method="post" enctype="multipart/form-data">
                ...
                <div class="item">内容：
                    <div class="content">
                        <textarea name="content" value=""><?=$item->content?></textarea>
                    </div>
                </div>
                <div class="item">图片：<img src="../img/<?=$item->img?>" id="pre"></div>
                <input id="img" hidden type="file" onchange="previewImage(this)" name="file">
                <input type="hidden" name="guess" value="<?php echo md5(sha1($_SESSION['name']."wechat")."youchat");//$_SESSION['guessrand']在本文件第二行已进行过定义
                ?>">
