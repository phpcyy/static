...
<body>
    ...
    <div class="body">
        <div class="table">
            <div class="nav">
                ...
                <a href="add.php"><label>添加新闻</label></a>
            </div>
            <div class="form">
                <table cellspacing="0px" class="admins">
                    ...
                    <tr>
                        ...
                        <td><?=$item->title;?></td>
                        <td><?=$item->content;?></td>
                        <td><a href="edit.php?id=<?=$item->id;?>"><label class="button edit">编辑</label></a><label class="del button">删除</label></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
    ...
    <script type="text/javascript">
        $(".del").on("click",function(){
            ...
            $e = $(this);
            $.post("../controller/delete.php",{id:id,guess:"<?php echo md5(sha1($_SESSION['name']."wechat")."youchat");?>"},function(data){
                if(data.status==1){
                    $e.closest("tr").remove();
                }
